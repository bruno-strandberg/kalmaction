...
public:
 ...
 private:
  ...
  static constexpr double m_acc_var = 1e-5;                  // variance of acceleration reading from IMU
  static constexpr double m_pos_var = 1e-5;                  // variance of pos reading from GPS
